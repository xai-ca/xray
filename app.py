...
# Import argumentation framework modules
from py_arg.abstract_argumentation_classes.abstract_argumentation_framework import AbstractArgumentationFramework
from py_arg.generators.abstract_argumentation_framework_generators.abstract_argumentation_framework_generator import AbstractArgumentationFrameworkGenerator
from py_arg.import_export.argumentation_framework_from_json_reader import ArgumentationFrameworkFromJsonReader
from py_arg.import_export.argumentation_framework_from_trivial_graph_format_reader import ArgumentationFrameworkFromTrivialGraphFormatReader
...
from py_arg.import_export.argumentation_framework_from_iccma23_format_reader import ArgumentationFrameworkFromICCMA23FormatReader
from py_arg.import_export.argumentation_framework_to_json_writer import ArgumentationFrameworkToJSONWriter
from py_arg.import_export.argumentation_framework_to_trivial_graph_format_writer import ArgumentationFrameworkToTrivialGraphFormatWriter
from py_arg.import_export.argumentation_framework_to_aspartix_format_writer import ArgumentationFrameworkToASPARTIXFormatWriter
from py_arg.import_export.argumentation_framework_to_iccma23_format_writer import ArgumentationFrameworkToICCMA23FormatWriter
...
from py_arg_visualisation.functions.explanations_functions.explanation_function_options import EXPLANATION_FUNCTION_OPTIONS
        ...
        dbc.Container(
            [
                ...
                dbc.Row(
                    [
                        dbc.Col(
                            html.Div(
                                [
                                    html.Img(src="/assets/logo.png", height="60px", className="me-3"),  # Logo Placeholder
                                    html.Span(
                                        "WESE",
                                        style={"font-weight": "bold", "color": "#333333", "font-size": "2rem"},
                                    ),
                                ],
                ...
                dbc.Row(
                    [
                        dbc.Col(
                            layout_abstract, width=12, className="shadow p-4 bg-light rounded flex-grow-1"
                        )
                    ]
                ),
                    ...
                    dbc.Col(
                        html.Footer(
                            [
                                ...
                                html.P(
                                    "Released under MIT License. Copyright © 2025 - Present UIUC CIRSS Center",
...
def evaluate_abstract_argumentation_framework(
    ...
    return html.Div(
        [
            ...
            html.P(
                "Click on the extension/argument buttons to display the corresponding argument(s) "
                "in the graph."
            ),
        ]
    )
...
app.layout = layout  # Assign the layout
